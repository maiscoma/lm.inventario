    ...
    const loadDashboardData = async () => {
      try {
        ...
        setStats({
          ...
          lowStockAlerts: lowStockResponse.data?.length || 0,
        ...
        <div className="card">
          ...
          {lowStockProducts.length > 0 && (
            <div className="mt-4 pt-4 border-t border-dark-border">
              {/* --- 3. Añade el onClick aquí --- */}
              <button onClick={() => navigate("/reportes/alertas")} className="w-full btn-secondary text-sm">
        ...
        <div className="card">
            ...
            {recentMovements.length > 0 ? (
              recentMovements.map((movement) => (
                <div key={movement.id} className="flex items-center gap-3 p-3 bg-dark-bg rounded-lg">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${movement.type === "entrada" ? "bg-success/20 text-success" : "bg-error/20 text-error"}`}>
          ...
          {recentMovements.length > 0 && (
            <div className="mt-4 pt-4 border-t border-dark-border">
              ...
              <button onClick={() => navigate("/movimientos")} className="w-full btn-secondary text-sm">
